...
model.add(Activation('relu'))
mode.add(BatchNormalization(mode=0,input_shape=(32,3,3)))
model.add(MaxPooling2D(pool_size=(2, 2)))
#model.add(Dropout(0.25))

model.add(Convolution2D(64, 3, 3, border_mode='same'))
model.add(Activation('relu'))
mode.add(BatchNormalization(mode=0,input_shape=(64,3,3)))
...
model.add(Dense(512))
model.add(Activation('relu'))
mode.add(BatchNormalization(mode=0,input_shape=(512)))
